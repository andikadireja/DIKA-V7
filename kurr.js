...
kurr.send5ButImg(m.chat, Anu, ` BOT BY ARGA HOST `, fatihgans, btn)
break
case 'listpc': {		
...
case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Group`, '© Copyright By ARGAHOST', m)
...
case 'kick': {
	...
	break
case 'sc':
if(from != "120363026415413995@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
	    ...
	    case 'setname': case 'setsubject': {
          ...
          case 'setppbot': {
           ...
           case 'setppgroup': case 'setppgrup': case 'setppgc': {
                ...
                break
case 'webp1':
if(from != "120363026415413995@g.us Ketuk pada klip untuk menempelnya pada kotak teks.") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(`Done ✓
...
case 'shorlink':
if(from != "120363026415413995@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` 𝗦𝗛𝗢𝗥𝗟𝗜𝗡𝗞 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : http://m-12.xyxz.ink\n\nKey : s`)
                                          break
case 'loginwhm':
if(from != "120363026415413995@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` https://raynesia.kevinstore.me:2087 : EROR MASZEHHH\nKALO EROR JANGGAN MAKSA KONTOLL:V`)
                                          break
case 'logincpanel':
if(from != "120363026415413995@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` https://raynesia.kevinstore.me:2083 : EROR MASZEHHH\nKALO EROR JANGGAN MAKSA KONTOLL:V`)
                                          break
case 'listpc': {
if (!isCreator) throw mess.owner
...
┃┊◎ .domain6 |  
┃
┃ MAO NAMBAHIN DOMAIN ? CHAT ARGA HOSTING🤖
┃
┗━❁━┈━❁━┈━❁━┈━❁━┛
...
┃┊◎ .domain6 |  
┃
┃ MAO NAMBAHIN DOMAIN ? CHAT ARGA HOST🤖
┃
┗━❁━┈━❁━┈━❁━┈━❁━┛
...
case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      kurr.send5ButImg(i, txt, '© ARGA HOSTING', global.thumb, btn)
                    }
        ...
        let sUser1 = "root";
        let sPass1 = "pw root";
        let serverName1 = "http://ns1.rayhostnesia.id";
        ...
        function subDomain1(host, ip) {
          return new Promise((resolve) => {
            ...
            axios
              .post(
                `https://api.cloudflare.com/client/v4/user/tokens/verify/${zone1}/dns_records`,
                { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld1, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
                {
                  headers: {
                    Authorization: "2uMcn8i60kCNNsAflfHU_qf_YIBY0NgHKH_k_OVO " + 4a736beec0b63dd1af58cfc39be00a2b,
        ...
        function subDomain2(host, ip) {
          return new Promise((resolve2) => {
            ...
            axios
              .post(
                `https://api.cloudflare.com/client/v4/user/tokens/verify${zone2}/dns_records`,
        ...
        subDomain7(host7, ip7).then((e) => {
          if (e['success']) m.reply(`𝙱𝙴𝚁𝙷𝙰𝚂𝙸𝙻 𝙼𝙴𝙽𝙰𝙼𝙱𝙰𝙷𝙼𝙰𝙽 𝚂𝚄𝙱𝙳𝙾𝙼𝙰𝙸𝙽\n𝙸𝙿 : ${e['ip']}\n𝙳𝙾𝙼𝙰𝙸𝙽 𝙽𝚈𝙰 𝚈𝙰 𝚂𝙰𝚃: ${e['name']}\n\nTELAH TERDAFTAR DI ${groupMetadata.subject}`);
          else m.reply(`YA GAGAL YA KASIAN\nMsg: ${e['error']}`)
        });
        break
            default:
                if (budy.startsWith('=>')) {
